...
int main(int argc, char* argv[]) {
    ...
    switch (choice) {
        case 0:
            ...
            runSmooth(assetPath, "output_06_smooth.usda", 10);
            break;
        ...
        case 6: runSmooth(assetPath, "output_06_smooth.usda", 1); break;
        default:
            std::cerr << "Invalid choice. Pass 0-6 as argument.\n";
            return 1;
    }
    return 0;
}
